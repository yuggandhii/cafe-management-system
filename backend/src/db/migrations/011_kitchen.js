exports.up = function(knex) {
  return knex.schema
    .createTable('kitchen_tickets', (t) => {
      ...
      t.integer('order_id').references('id').inTable('orders').onDelete('CASCADE').unique();
    ...
    .createTable('kitchen_ticket_items', (t) => {
      t.increments('id').primary();
      t.integer('ticket_id').references('id').inTable('kitchen_tickets').onDelete('CASCADE');
      t.integer('order_line_id').references('id').inTable('order_lines').onDelete('CASCADE');
